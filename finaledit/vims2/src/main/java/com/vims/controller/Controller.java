...
public class Controller {
	...
	public ResponseEntity<?> saveCustomer(@RequestBody Customer customer) {
		...
		List<String>names=custService.findAllNames();
		//System.out.println(names);
		if(names.contains(user)){
			return new ResponseEntity<String>("Username already exists please try another Username", HttpStatus.OK);
		}
		String pass=customer.getPassword();
		Customer cid=custService.findByCustomer(user, pass);
		Date d=new Date();
